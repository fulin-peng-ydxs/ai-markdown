...
- 当前实现架构见 [`desktop-foundation.md`](agent-works/markdown-editor-desktop/architecture/desktop-foundation.md)；代码、清单和测试仍是最终技术事实源。
...
- 工程与已验证命令以 `README.md`、`AGENTS.md`、清单和 CI 配置为准；未登记的新命令不得凭计划猜测为可用。
