...
- 修改代码或文档前检查最近一次远端同步时间；超过 2 小时先同步并解决冲突。最近一次远端同步：2026-07-22 11:58 CST（当前分支跟踪 `origin/codex/plainroot-stage-1`；提交 `9a1690a` 已推送并通过双平台 CI）。
