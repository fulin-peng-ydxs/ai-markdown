...
| R3 | 所见即所得 Markdown 编辑 | 完整纳入本阶段 | 进行中 | T18、T19、T23、T25、T30～T32 | T18 已通过依赖、结构往返、程序化中文输入与包体门禁；真实 IME、产品编辑与 E2E 仍待后续任务 |
...
| R10 | Markdown 源码模式 | 完整纳入本阶段 | 进行中 | T18、T19、T24、T25、T30～T32 | T18 已验证 CodeMirror 创建/销毁、程序化中文变更和源码安全降级；真实 IME 与正式源码模式仍待实现 |
...
| 必须实现 | R3 | 所见即所得编辑 | Milkdown、统一模型、格式化、粘贴和往返 | T18、T19、T23、T25、T30～T32 | 进行中 | 部分覆盖 | T18 依赖与结构往返门禁已完成；真实 IME 和正式 P1 编辑器尚未完成 |
