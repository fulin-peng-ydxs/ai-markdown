...
>
> 计划状态：执行中（T35～T36 已完成；T37～T46 未实施）
>
...
| R13 | 完整纳入：真实页签、唯一打开、排序、批量关闭、溢出、最近关闭、独立会话和恢复 | 进行中 | 一致 | T35～T46 | T35 已完成纯状态机；T36 已完成内容无关会话仓储和 Rust 路径身份契约；真实 runtime、页面与结算未实施 |
...
| 必须实现 | R13 | 多文档页签与最近关闭文档 | 完整实现真实页签、排序、批量关闭、最近关闭和会话恢复 | T35～T46 | 进行中 | 一致 | T35 已完成纯状态机，T36 已完成内容无关会话仓储与路径身份契约；真实 runtime/adapter、页面、结算、E2E 与验收仍待后续任务 |
