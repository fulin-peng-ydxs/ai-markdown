...
- `pnpm test:tabs`：8 个文件，61/61。
- 全量 Vitest：31 个文件，247/247。
...
- T40 本轮未重跑 Tauri/WebKit 桌面 E2E；最近 10/10 本地桌面证据属于 T39，不能外推覆盖本次批量弹层和文件操作链路。
- Windows、远端 CI、系统辅助技术和真实原生文件操作的 T40 新链路未验证。
