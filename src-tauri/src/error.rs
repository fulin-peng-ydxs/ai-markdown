...
define_desktop_error_codes!(
    ...
    InvalidStateData,
    WindowSessionUnavailable,
    WindowSessionReadFailed,
    WindowSessionWriteFailed,
    WindowSessionUnsupportedVersion,
    WindowSessionNotFound,
    WindowSessionCorrupt,
    WindowSessionRevisionConflict,
    WindowSessionCapacityExceeded,
    DialogUnavailable,
...
impl DesktopErrorCode {
    pub const fn message_key(self) -> &'static str {
        match self {
            ...
            Self::MenuUpdateFailed => "error.menu.updateFailed",
            ...
            Self::WindowSessionUnavailable => "error.windowSession.unavailable",
            Self::WindowSessionReadFailed => "error.windowSession.readFailed",
            Self::WindowSessionWriteFailed => "error.windowSession.writeFailed",
            Self::WindowSessionUnsupportedVersion => "error.windowSession.unsupportedVersion",
            Self::WindowSessionNotFound => "error.windowSession.notFound",
            Self::WindowSessionCorrupt => "error.windowSession.corrupt",
            Self::WindowSessionRevisionConflict => "error.windowSession.revisionConflict",
            Self::WindowSessionCapacityExceeded => "error.windowSession.capacityExceeded",
