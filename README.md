...
Plainroot 是面向 Windows 与 macOS 的本地优先 Markdown 桌面编辑器。第一阶段 T1～T17 已完成本地、macOS 实机与 macOS/Windows 双平台 CI 验收：当前具备 Tauri/React 工程、受控工作区授权、文件扫描与安全写入底座、文件操作/监听、原生窗口菜单、工作区窗口协调、真实 P2 启动页以及隔离的 P1/P2 桌面 E2E。第二阶段 T18～T27 已完成编辑器技术门禁、统一单文档会话、有界跨模式历史、恢复/冲突/另存/资源后端契约、Milkdown/CodeMirror adapter、P1 统一编辑器壳、排版/源码安全切换、自动/手动保存、窗口关闭/替换/退出结算，以及 P1/P2 可见的恢复、冲突、另存副本和外部删除保护流程；当前仍没有页签、大纲、资源目录弹层或完整图片输入，第二阶段桌面 E2E 与双平台完整验收尚未完成。
